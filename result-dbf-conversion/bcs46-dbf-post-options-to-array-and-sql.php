...
//Input DBF File
$dbf_file = __DIR__ . '\..\file-io\file-to-convert\for-result\bcs_option46.DBF';

//Output SQL File for 'cadres' table
$cadres_sql_out_file      = __DIR__ . '/../file-io/file-output/dbf-to-file/bcs-result/bcs46/cadres/cadres_sql_bcs46.sql';

//Output SQL File for 'posts' table
$posts_sql_out_file       = __DIR__ . '/../file-io/file-output/dbf-to-file/bcs-result/bcs46/posts/posts_sql_bcs46.sql';

//Output PHP-ARRAY File for 'cadres'
$cadres_php_array_file    = __DIR__ . '/../file-io/file-output/dbf-to-file/bcs-result/bcs46/cadres/cadres_array_bcs46.php';

//Output PHP-ARRAY File for 'posts'
$posts_php_array_file     = __DIR__ . '/../file-io/file-output/dbf-to-file/bcs-result/bcs46/posts/posts_array_bcs46.php';
...
//Fields of DBF File, for CADRES
$select_fields_cadres = [
    'OPT_CODE', 'OPT_DESC', 'P_NAME', 'CADRE'
];

//Fields of DBF File, for POSTS
$select_fields_posts = [
    'OPT_CODE', 'POST_NO', 'MERIT', 'FF_QUOTA', 'EM_QUOTA', 'PHC_QUOTA'
];

//Mapping of DBF File Fields to My-SQL Table Columns; for CADRES
$field_map_cadres = [
    'OPT_CODE' => 'cadre_code',
    'OPT_DESC' => 'cadre_abbr',
    'P_NAME'   => 'cadre_name',
...
//Mapping of DBF File Fields to My-SQL Table Columns; for POSTS
$field_map_posts = [
    'OPT_CODE'  => ['cadre_code'],
...
}  //End of function 'map_fields_simple()'
...
}  //End of function 'map_fields_multi()'
...
}  //End of function 'generate_sql_inserts()'
...
}  //End of function 'write_php_array_file()'
