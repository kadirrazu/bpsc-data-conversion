...
//Input DBF File
$dbf_file = __DIR__ . '\..\file-io\file-to-convert\for-result\bcs_option45.DBF';

//Output SQL File for 'cadres' table
$cadres_sql_out_file      = __DIR__ . '/../file-io/file-output/dbf-to-file/bcs-result/bcs45/cadres/cadres_sql_bcs45.sql';

//Output SQL File for 'posts' table
$posts_sql_out_file       = __DIR__ . '/../file-io/file-output/dbf-to-file/bcs-result/bcs45/posts/posts_sql_bcs45.sql';

//Output PHP-ARRAY File for 'cadres'
$cadres_php_array_file    = __DIR__ . '/../file-io/file-output/dbf-to-file/bcs-result/bcs45/cadres/cadres_array_bcs45.php';
