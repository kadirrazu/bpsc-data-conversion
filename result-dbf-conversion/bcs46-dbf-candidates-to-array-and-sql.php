...
//Input DBF File
$dbf_file = __DIR__ . '\..\file-io\file-to-convert\for-result\tab_fin_bcs46.DBF';

//Output SQL-INSERT File
$sql_output_file = __DIR__ . '/../file-io/file-output/dbf-to-file/bcs-result/bcs46/candidates/candidates_sql_bcs46.sql';

//Output PHP-ARRAY File
$php_array_output_file = __DIR__ . '/../file-io/file-output/dbf-to-file/bcs-result/bcs46/candidates/candidates_array_bcs46.php';
