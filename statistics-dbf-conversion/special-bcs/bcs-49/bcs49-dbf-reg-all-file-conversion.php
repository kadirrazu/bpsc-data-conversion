...
//Input DBF File
$dbf_file = __DIR__ . '\..\..\..\file-io\file-to-convert\for-statistics\reg_all_bcs49.DBF';

//Output SQL-INSERT File
$sql_output_file = __DIR__ . '/../../../file-io/file-output/dbf-to-file/bcs-statistics/bcs49/sql_reg_all_bcs49.sql';

$php_array_output_file = __DIR__ . '/../../../file-io/file-output/dbf-to-file/bcs-statistics/bcs49/array_reg_all_bcs49.php';

//Encoding of DBF File
$encoding = 'CP1252';

//Table name
$table_name = "registrations_49";
