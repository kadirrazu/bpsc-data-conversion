...
$sql_out_file = __DIR__ . '/conversion-output/dbf-to-file/output_candidates_sql_bcs44.sql';
$php_array_file = __DIR__ . '/conversion-output/dbf-to-file/output_candidates_array_bcs44.php';
